...
export const DEFAULT_META_FIELDS: StructureField[] = [
    { id: "address", label: "Address", placeholder: "Full Property Address", displayType: "text", ifValidation: true, type: "string" },
    { id: "contactName", label: "Contact Name", placeholder: "Name", displayType: "text", ifValidation: false, type: "string" },
    { id: "contactPhone", label: "Contact Phone", placeholder: "Phone", displayType: "text", ifValidation: false, type: "string" },
    { id: "contactEmail", label: "Contact Email", placeholder: "Email", displayType: "text", ifValidation: false, type: "string" },
    { id: "price", label: "Price", placeholder: "0.00", displayType: "number", ifValidation: false, type: "number" },
    { id: "isPaid", label: "Is Paid", placeholder: "", displayType: "checkbox", ifValidation: false, type: "boolean" },
    { id: "jobNumber", label: "Job Number", placeholder: "Job #", displayType: "text", ifValidation: false, type: "string" },
    { id: "splitRatio", label: "Split Ratio", placeholder: "100", displayType: "number", ifValidation: false, type: "number" },
    { id: "primaryValuer", label: "Primary Valuer", placeholder: "Valuer Name", displayType: "text", ifValidation: false, type: "string" },
];

export const DEFAULT_BASIC_FIELDS: StructureField[] = [
    { id: "singleLineAddress", label: "Address", placeholder: "Full Property Address", displayType: "text", ifValidation: false, type: "string" },
    { id: "multiLineAddress", label: "Address (Multi-line)", placeholder: "Line 1...", displayType: "textarea", ifValidation: false, type: "string" },
    { id: "instructedBy", label: "Instructed By", placeholder: "Instructor Name", displayType: "text", ifValidation: false, type: "string" },
    { id: "jobNo", label: "Job No", placeholder: "Job Number", displayType: "text", ifValidation: false, type: "string" },
    { id: "preparedFor", label: "Prepared For", placeholder: "Client Name", displayType: "text", ifValidation: false, type: "string" },
    { id: "clientBorrower", label: "Client/Borrower", placeholder: "Borrower Name", displayType: "text", ifValidation: false, type: "string" },
    { id: "valuationDate", label: "Date of Valuation", placeholder: "Select date", displayType: "date", ifValidation: false, type: "string" },
];
